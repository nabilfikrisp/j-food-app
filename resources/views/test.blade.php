...
<body>
    ...
    <header class="bg-white dark:bg-gray-900" aria-label="Site Header">
    ...
    <div class="w-96">
        <div class="relative" x-data="{ isActive: false }">
            <div class="inline-flex items-center overflow-hidden rounded-md border bg-white">
                <a class="border-e text-sm/none px-4 py-2 text-gray-600 hover:bg-gray-50 hover:text-gray-700"
                   href="#">
                    Edit
                </a>
            ...
            <div class="end-0 absolute z-10 mt-2 w-56 rounded-md border border-gray-100 bg-white shadow-lg"
                ...
                <div class="p-2">
                    ...
                    <form method="POST" action="#">
                        <button class="flex w-full items-center gap-2 rounded-lg px-4 py-2 text-sm text-red-700 hover:bg-red-50"
