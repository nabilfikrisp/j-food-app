    ...
    <div class="mx-auto max-w-screen-xl px-4 py-5 sm:px-6 lg:px-8">
        <div class="grid sm:grid-cols-2 grid-cols-1">
            ...
            <div class="flex flex-col gap-y-5">
                ...
                <div class="flex gap-x-4" id="social-medias">
                    <div class="h-8 w-8" id="instagram">
                        <a href="">
                            <svg class="fill-orange stroke-none hover:fill-none hover:stroke-orange" role="img"
